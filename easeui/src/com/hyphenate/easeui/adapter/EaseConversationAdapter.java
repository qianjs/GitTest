    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (conversation.getType() == EMConversationType.GroupChat) {
            ...
            if (username.equals("admin")){
                ...
                EaseUserUtils.setUserNick("验证消息", holder.name);

            }else {
                EaseUserUtils.setUserAvatar(getContext(), username, holder.avatar);
                EaseUserUtils.setUserNick(TextUtils.isEmpty(EaseUserUtils.getNickname(username,context))?username:EaseUserUtils.getNickname(username,context), holder.name);
                holder.motioned.setVisibility(View.GONE);
            }
        ...
        if (conversation.getAllMsgCount() != 0) {
            ...
            if (username.equals("admin")){
                holder.message.setText("收到一条验证消息，请查看");
            }else {
