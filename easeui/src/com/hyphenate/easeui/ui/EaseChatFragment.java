...
import static com.hyphenate.easeui.R.string.nickname;
...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        nickname = fragmentArgs.getString(EaseConstant.EXTRA_NICKNAME);
        super.onActivityCreated(savedInstanceState);
    }
    public void setInputMenuVisible(boolean b)
    {
        if(b)
        {
...
//                }
//            }
            titleBar.setTitle(TextUtils.isEmpty(nickname)?toChatUsername:nickname);
