...
//        TextView tvNotify = new TextView(context);
//        tvNotify.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 12);
//        tvNotify.setTextColor(Color.RED);
//        tvNotify.setText("红色代表未签到");
//        tvNotify.setPadding(MeasureUtil.dp2px(context, 5),0,0,0);
//        addView(tvNotify);
//        TextView tvNotify2 = new TextView(context);
//        tvNotify2.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 12);
//        tvNotify2.setTextColor(Color.BLUE);
//        tvNotify2.setText("蓝色代表未确认");
//        tvNotify2.setPadding(MeasureUtil.dp2px(context, 5),0,0,0);
//        addView(tvNotify2);
//        TextView tvNotify3 = new TextView(context);
//        tvNotify3.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 12);
//        tvNotify3.setTextColor(Color.YELLOW);
//        tvNotify3.setText("黄色代表未支付");
//        tvNotify3.setPadding(MeasureUtil.dp2px(context, 5),0,0,0);
//        addView(tvNotify3);
//        TextView tvNotify4 = new TextView(context);
//        tvNotify4.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 12);
//        tvNotify4.setTextColor(Color.GREEN);
//        tvNotify4.setText("绿色代表已完成");
//        tvNotify4.setPadding(MeasureUtil.dp2px(context, 5),0,0,0);
//        addView(tvNotify4);
    }
