...
public class NewGroupAdapter extends ArrayAdapter<EMGroup> {

	private LayoutInflater inflater;
//	private String newGroup = "创建新群组";


	public NewGroupAdapter(Context context, int res, List<EMGroup> groups) {
...
//			}
//			((ImageView) convertView.findViewById(R.id.avatar)).setImageResource(R.mipmap.em_create_group);
