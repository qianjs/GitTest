...
public class ArbitrationInfoLeaseActivity extends BaseActivity{
    ...
    private void initData() {
        ...
        if (getIntent().getStringExtra("signCustomerId") != null){
    ...
    private void requestData(){
        ...
        XUtil.Post(UrlUtils.URL_ARBITRATE_INFO_LEASE, map, new MyCallBack<String>(){
            @Override
